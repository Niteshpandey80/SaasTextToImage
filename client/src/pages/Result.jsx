...
const Result = () => {
  ...
  return (
    <form className="flex flex-col min-h-[90vh] justify-center items-center px-4">
      <div className="flex flex-col items-center">
        <div className="relative">
          ...
          />
          <span className="absolute bottom-0 left-0 h-1 bg-blue-500 w-full animate-[loadingBar_10s_linear_infinite]" />
        </div>
        <p className="mt-4 text-gray-600 text-sm tracking-wide animate-pulse">Generating your image...</p>
      </div>
