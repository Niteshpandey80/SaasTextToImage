  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <p
          className={`mt-4 text-gray-600 text-sm tracking-wide animate-pulse ${
            !loading ? 'hidden ' : ''
          }`}
        >
      ...
      {!isImageLoaded && (
        <div className="flex w-full max-w-2xl bg-white/80 backdrop-blur-md shadow-md border border-gray-200 text-gray-800 text-sm p-1 mt-7 rounded-full overflow-hidden">
          <input
      ...
      {isImageLoaded && (
        <div className="flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-7 rounded-full">
          <p
